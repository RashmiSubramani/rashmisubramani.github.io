...
`;y.div`
  ...
  animation: ${e=>e.$heavy?$m:da} ${e=>e.$duration}s linear infinite,
             ${e=>e.$pattern==="swirl"?l2:e.$pattern==="zigzag"?Rm:Em} ${e=>e.$duration*.6}s ease-in-out infinite;
  animation-delay: ${e=>e.$delay}s;
  opacity: ${e=>e.$opacity};
  box-shadow: 
